...
mnist = tf.keras.datasets.mnist # Load the labeled datas
(x_train, y_train), (x_test, y_test) = mnist.load_data() # x for pixel data and y for classification
